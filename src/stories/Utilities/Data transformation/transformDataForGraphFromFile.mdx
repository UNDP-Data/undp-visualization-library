...
- `dataConfiguration` - The graph configuration data used to determine how the data should be formatted for the graph. The schema for dataConfiguration for different chart can be found [here](../?path=/docs/misc-graph-config--docs)
