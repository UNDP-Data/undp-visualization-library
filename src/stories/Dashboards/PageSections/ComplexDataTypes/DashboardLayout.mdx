...
<Meta title="Dashboard/Data types/dashboardLayout" />
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        more](?path=/docs/dashboard-data-types-graphtype--docs)
      </td>
    </tr>
    <tr>
      ...
      <td>
        ...
        to charts like <code>barChart</code>,<code>choroplethMap</code>,{' '}
