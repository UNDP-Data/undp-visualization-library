      ...
      {showLegend ? (
        <div className='undp-viz-bivariate-legend-container relative'>
          <div className='self-start flex mb-3 undp-viz-bivariate-legend'>
              ...
              <div className='py-3 pr-14 pl-3 relative z-10'>
                <div className='flex pointer-events-auto'>
                  <div>
                    ...
                    <div
                      className='$leading-normal text-primary-gray-700 dark:text-primary-gray-100 mt-2 text-center non-italic text-sm overflow-hidden'
                      style={{
                        display: '-webkit-box',
                        WebkitLineClamp: '2',
                        width: '8.125rem',
                  ...
                  <div
                    className='leading-normal text-primary-gray-700 dark:text-primary-gray-100 text-center non-italic text-sm overflow-hidden absolute'
                    style={{
                      width: '8.125rem',
                      display: '-webkit-box',
                      top: '80px',
            ...
            <button
              type='button'
              className='mt-2 mb-0 ml-9 mr-2 cursor-pointer border-0 h-6 p-0'
              onClick={() => {
                setShowLegend(false);
              }}
            >
